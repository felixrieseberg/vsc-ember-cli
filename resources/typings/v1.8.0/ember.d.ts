...
declare module 'ember' {
  export namespace Ember {
    ...
    /**
     * Where `computed.oneWay` provides oneWay bindings, `computed.readOnly` provides a readOnly one way binding. Very often when using `computed.oneWay` one does not also want changes to propogate back up, as they will replace the value.
     */
     ...
     */
    function addListener(obj: any, eventName: string, targetOrMethod: {}|Function, method: Function|string, once: boolean);
    /**
     * Remove an event listener
     */
    function removeListener(obj: any, eventName: string, targetOrMethod: {}|Function, method: Function|string);
    /**
    ...
    function removeObserver(obj: any, path: string, targetOrMethod: {}|Function, method: Function|string);
    function addBeforeObserver(obj: any, path: string, targetOrMethod: {}|Function, method: Function|string);
    function removeBeforeObserver(obj: any, path: string, targetOrMethod: {}|Function, method: Function|string);
    /**
    ...
    export namespace Handlebars {
       ...
       */
      function getEscaped(root: {}, path: string, options: {});
      /**
      ...
      export class helpers {
        ...
        textarea(options: {});
        /**
         * The `{{action}}` helper provides a useful shortcut for registering an HTML element within a template for a single DOM event and forwarding that interaction to the template's controller or specified `target` option. If the controller does not implement the specified action, the event is sent to the current route, and it bubbles up the route hierarchy from there. For more advanced event handling see [Ember.Component](/api/classes/Ember.Component.html)
         */
         ...
         */
        render(name: string, contextString: {}, options: {}): string;
      }
      /**
    ...
    export class ControllerMixin implements ActionHandler {
       ...
       */
      set(object: {}, key: string, value: any);
      /**
    ...
    export class Vertex {
      ...
      topsort(fn: Function);
      /**
       * Adds a vertex with the given name and value to the graph and joins it with the vertices referenced in _before_ and _after_. If there isn't vertices with those names, they are added too.
       */
      addEdges(name: string, value: any, before: any, after: any);
    }
    /**
     ...
     */
    export class ContainerDebugAdapter {
      /**
    ...
    export class TextArea extends Component implements TextSupport {
      ...
      /**
       * Called when the user presses a key. Enabled by setting the `onEvent` property to `keyPress`.
       */
     ...
     */
    export class _HandlebarsBoundView extends _MetamorphView {
      /**
      ...
      /**
       * The path to look up on `pathRoot` that is passed to `shouldDisplayFunc` to determine which template to render.
       */
      path: string;
      /**
       * The object from which the `path` will be looked up. Sometimes this is the same as the `previousContext`, but in cases where this view has been generated for paths that start with a keyword such as `view` or `controller`, the path root will be that resolved object.
       */
      pathRoot: {};
      /**
    ...
    export class Instrumentation {
       ...
       */
      getProperties(obj: any, ...list: string[]): {};
      /**
    ...
    export class run {
      ...
      /**
       * Provides a useful utility for when integrating with non-Ember libraries that provide asynchronous callbacks.
       */
      bind(target: {}, method: Function|string, ...args: any[]): {};
      /**
    ...
    export class Route extends Object implements ActionHandler {
       ...
       */
      beforeModel(transition: Transition, queryParams: {}): Promise<any>;
      /**
       ...
       */
      afterModel(resolvedModel: {}, transition: Transition, queryParams: {}): Promise<any>;
      /**
       ...
       */
      model(params: {}, transition: Transition, queryParams: {}): {}|Promise<any>;
     ...
     */
    export class Router extends Object {
      /**
    ...
    export class LinkView extends View {
      ...
      replace: boolean;
      /**
       * By default the `{{link-to}}` helper will bind to the `href` and `title` attributes. It's discourage that you override these defaults, however you can push onto the array if needed.
       */
    ...
    export class ArrayController extends ArrayProxy implements SortableMixin, ControllerMixin {
      /**
       * The controller used to wrap items, if any. If the value is a string, it will be used to lookup the container for the controller. As an alternative, you can also provide a controller class as the value.
       */
    ...
    /**
     * `Ember.SortableMixin` provides a standard interface for array proxies to specify a sort order and maintain this sorting when objects are added, removed, or updated without changing the implicit order of their underlying modelarray:
     */
