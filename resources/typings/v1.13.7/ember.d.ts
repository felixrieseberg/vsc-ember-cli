  ...
  export namespace Ember {
    ...
    export namespace Templates {
      export class helpers {
        ...
        debugger();
        /**
         * The `mut` helper lets you __clearly specify__ that a child `Component` can update the (mutable) value passed to it, which will __change the value of the parent compnent__.
         */
        mut(attr: {});
        /**
