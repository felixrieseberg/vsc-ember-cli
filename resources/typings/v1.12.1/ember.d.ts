...
declare module 'ember' {
  export namespace Ember {
     ...
     */
    function unknownProperty(keyName: string, value: any);
    /**
    ...
    export class AttributeBindingsSupport {
      /**
    ...
    export class ViewChildViewsSupport {
      /**
    ...
    export class ViewsContextSupport {
      /**
     ...
     */
    export class View extends CoreView implements ViewChildViewsSupport, TemplateRenderingSupport, ClassNamesSupport, AttributeBindingsSupport, LegacyViewSupport, InstrumentationSupport, VisibilitySupport {
