...
declare module 'ember' {
  export namespace Ember {
    ...
    export namespace stream {
      /**
       * A method of subscribing to a stream which is safe for use with a non-stream object. If a non-stream object is passed, the function does nothing.
       */
      function subscribe(object: {}|Stream, callback: Function, context: {});
      /**
       * A method of unsubscribing from a stream which is safe for use with a non-stream object. If a non-stream object is passed, the function does nothing.
       */
      function unsubscribe(object: {}|Stream, callback: Function, context: {});
      /**
       * Retrieve the value of a stream, or in the case a non-stream object is passed, return the object itself.
       */
      function read(object: {}|Stream): void;
      /**
       * Map an array, replacing any streams with their values.
       */
      function readArray(array: Ember.Array): Ember.Array;
      /**
       * Map a hash, replacing any stream property values with the current value of that stream.
       */
      function readHash(object: {}): {};
      /**
       * Check whether an array contains any stream values
       */
      function scanArray(array: Ember.Array): boolean;
      /**
       * Check whether a hash has any stream property values
       */
      function scanHash(hash: {}): boolean;
      /**
       * Join an array, with any streams replaced by their current values
       */
      function concat(array: Ember.Array, separator: string): string;
      /**
       ...
       */
      function chain(value: {}|Stream, fn: Function): {}|Stream;
      export namespace Ember {
        export class stream {
          /**
           * Check whether an object is a stream or not
           */
          isStream(object: {}|Stream): boolean;
        }
      }
      export class Stream {
      }
